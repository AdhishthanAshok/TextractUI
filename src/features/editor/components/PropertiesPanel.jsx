...
export default function PropertiesPanel({ selectedIndex, rectangles, setRectangles, imageNaturalSize, onDelete }) {
    const r = typeof selectedIndex === 'number' ? rectangles[selectedIndex] : null;

    const handleDelete = () => {
        if (typeof selectedIndex !== 'number') return;
        onDelete(); // Call the function passed from Editor.jsx
    };
